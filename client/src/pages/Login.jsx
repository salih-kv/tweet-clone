...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            (await response.data.status) && setLoggedIn(true).catch((err) => console.log("error=", err.message));
    ...
    return (
        <div className="dark:bg-[#151C24] w-full min-h-screen flex justify-between items-center">
            ...
            <div className="flex flex-col items-center w-screen">
                <form className="flex flex-col gap-4 sm:w-[500px] max-sm:w-10/12" onSubmit={handleSubmit}>
                    <article className=" mb-4 self-start">
                        <h2 className="font-bold dark:text-white text-2xl mb-2">Sign in to your account</h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Enter your details below</p>
                    </article>
                    <Input
                        type="text"
